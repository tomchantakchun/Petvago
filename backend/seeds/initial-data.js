  ...
  .then(function(){
    ...
    .then(function () {
      ...
      return knex('booking').insert([
        ...
        {userID:1, hotelID:1, roomTypeID:2, expiryTime:'2018-01-07T08:36:00',startDate:'2019-2-7', endDate:'2019-2-8',duration:3,service:{Bath:1,['Obedience training']:2},totalPrice:1200,status:'confirmed',ownerName:'Katy Chan',ownerPhone:91234567,petName:'Pooh',petWeight:15,petType:'dog',vaccineRequirement:{vaccine:['DHPPiL','Rabies','Kennel Cough']}},
        {userID:1, hotelID:1, roomTypeID:3, expiryTime:'2018-01-07T08:36:00',startDate:'2019-2-10', endDate:'2019-2-12',duration:3,service:{Bath:1,['Obedience training']:2},totalPrice:1200,status:'confirmed',ownerName:'Katy Chan',ownerPhone:91234567,petName:'Pooh',petWeight:15,petType:'dog',vaccineRequirement:{vaccine:['DHPPiL','Rabies','Kennel Cough']}},
