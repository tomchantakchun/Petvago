...
class Confirmation extends Component {
    ...
    componentDidMount(){
        ...
        axios.get(`http://petvago.site/api/userprofile`, { headers: { Authorization: `Bearer ${jwt}` } }).then((result)=>{
        ...
        axios.get(`http://petvago.site/api/booking/user`, { headers: { Authorization: `Bearer ${jwt}` } }).then((result)=>{
    ...
    getReview=()=>{
        ...
        axios.get(`http://petvago.site/api/review/user`, { headers: { Authorization: `Bearer ${jwt}` } }).then((result)=>{
            this.setState({
    ...
    contactHotel=(hotelID)=>{
        ...
        axios.post(`http://petvago.site/api/chatroom/addchat`,{hotelID}, { headers: { Authorization: `Bearer ${jwt}` } })
        .then((result)=>{
    ...
    submitReview=(e)=>{
        ...
        axios.post(`http://petvago.site/api/review`,data, { headers: { Authorization: `Bearer ${jwt}` } }).then((result)=>{
            getReview()
        }).catch(err=>console.log(err))
    }
